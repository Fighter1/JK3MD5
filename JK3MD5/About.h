...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(83, 55);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(102, 26);
			this->label1->TabIndex = 0;
			this->label1->Text = L"JK3 MD5";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(73, 93);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(29, 129);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(218, 26);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Developed by Fighter";
